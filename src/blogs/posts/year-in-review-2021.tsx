...
const BlogPost: React.FC<any> = () => {
  return (
    <>
      ...
      <P>
        I met great new friends and spent quality time with old ones. I trained
        and raced in my first half Iron Man and my third marathon. I skied a
        ton. I launched features for Google and YouTube reaching millions of
      ...
      <P>
        ...
        and a great group of 10 other friends. Afterwards I lived with my
        parents and brother in Virginia for a month. In April, I moved back into
        NYC with my longtime friend AJ. I trained and ran a triathlon with 3 of
        my closest friends AJ, Chris, and Johnny. Then I left Google to work
        full time on OnePager with Nic and Adam, more great friends. Through all
        of these experiences I’ve gotten to spend time with my favorite people
        and meet new ones along the way—notably all of the great new founders
        I’ve met while building OnePager.
      </P>
      <P>
        I also got to experience my first batch of friends' weddings: congrats
        again to the Griffins, the Hardejs, and the O’Connors! All incredible
        experiences, awesome groups of friends, and I’m excited for more in
        2022.
      </P>
      <P>
        Three more highlights: #1 a week with Tori living on Alistair and
        George’s houseboat in Sausalito. #2 a four day camping trip I took with
        5 friends in Zion national park. #3 Memorial day weekend, where I
        brought together my family and friends together in Massachusetts for a
        great weekend in the pouring rain.
      </P>
      <PostImage
      ...
      <P>
        ...
        day. I’d never skied more than a few days in a year before, but over the
        course of 2 months I got on the mountain 36 separate days. I loved it,
        but eventually I missed NYC and it was time to reenter the real world.
      </P>
      <P>
        ...
        biking. I was also lucky to be training for the race with three good
        friends, one of which was my roommate AJ.
      </P>
      <P>
        The triathlon was on June 6th in Roanoke, Virginia, and happened to land
        on the 77th anniversary of D-Day and the invasion of Normandy during
        WWII. At the start of the race, the congressman for the surrounding
        districts gave a speech about the significance of our event happening in
        Roanoke on this day. With the sun rising over a reservoir in the Blue
        Ridge Mountains behind him, he explained that the “Bedford Boys,” kids
        from the nearby Bedford county, were the tip of the spear on D-Day and
      ...
      <P>
        ...
        Unfortunately, the run was a disaster. It was 90 degrees by the time I
        began the run, and I’d overexerted myself on the bike. By mile 3 I
        started cramping in my legs. By mile 7 crippling cramps forced me to
        run-walk the last 6 miles. I ran through the finish strong, but ask me
        in person for the hilarious finish line details 🤖.
      </P>
      <P>
      ...
      <P>
        ...
        LLS. With the three races under our belt, we’ve raised $96,458!
      </P>
      <P>
      ...
      <P>
        ...
        students relying on Google Search. There hadn’t been any focus on
        academic learning queries in the past, so we built new search features
        to improve that experience (in contrast, tons of search features have
        been built for movies, music, and TV queries). In the fall, my team
        launched{' '}
      ...
      <P>
        My goal, as it was within Search, was to build features that improve the
        experience of students using YouTube as a learning tool. Some education
        specific efforts did exist within YouTube, but our team had useful
        knowledge on the shared infrastructure between Search and YouTube and
        wanted to make a bigger, more targeted effort. So I built a set features
        to help students find relevant learning content and focus while watching
        it. Removing distractions proved to be a difficult task—YT is optimized
        to increase user watch time, which at times directly opposed
        recommending high quality educational content. Despite that difficulty,
        I designed, built, and launched a set of these features, the first from
        our team within the YouTube product.
      </P>
      <P>
        As an aside, in one of my experiments I crashed the YouTube "what to
        watch next" recommendation service. Apologies to the 0.5% of US-based
      ...
      <P>
        ...
        . After a rocky 9:00pm-2:00am (issues pushing large backlog of changes
        to prod), the rest of the launch went great, and we got our biggest user
        bump yet. OnePager was now a fully built out product, not a prototype.
      </P>
      <P>
      ...
      <P>
        ...
        their companies with better tools and collect affiliate conversion
      ...
      <P>
        With this model taking shape, I was completely torn. OnePager was
        growing with only my part time work and leadership, but I knew I had
        more to offer. The business had a fighting chance and it needed my full
      ...
      <P>
        I spent weeks deliberating and decided that OnePager was the best path
        forward for me. I owe it mostly to my good friend and co-founder Adam
        for ruthlessly recruiting me, and I’m also thankful for all the advice I
        got from friends, family, and mentors (my parents, Tori, Nic, Rich
        Napolitano, Mac Cordrey, Dawit Heck, Luke Armour, Anna Doherty, Ed
        Parizeau, Michael Greenberg, Suhail Doshi, Tom Cecil, Safwan Chowdrey,
        and Jon Novatnack to name a few).
      </P>
      <P>
        This felt like an insane decision (people kill to work at Google!), so I
        wrote our my reasoning in an essay to make sure I knew what I was
        getting into. I went through the pros and cons of both paths, my
        thoughts after various conversations, and my long term goals. The essay
      ...
      <PostImage
        ...
        subtitle="Adam and I in our OnePager WeWork office! (We were able to move in a day early and Nic couldn't make it, so really this is day -1)"
        h={3088}
        w={2316}
      />
      ...
      <P>
        ...
        first ~8 weeks were a heads down blur. We moved into a WeWork to have a
        dedicated space and got to work. Nic and I had built out a long backlog
        of bugs, styling changes, and long awaited features, so the "what to do"
        felt straightforward. Long hours building, testing, and launching. We
      ...
      <P>
        ...
        companies via email. We were able to get the Amazon partnership by
        manually offering all users free AWS credits, but needed to recommend
        all sorts of software to various business types. So, I built out our V1
        of automated product recommendations. It worked well off the bat, but
        didn't garner the user engagement we’d hoped. We kept building and
        pushed forward.
      </P>
      <P>
        ...
        to name a few. Right away the group was impressed by our initial
        traction, and some had even heard of us! But, others suggested OnePager
        needed to focus more on growth, and they turned out to be right.
      </P>
      <P>
        ...
        <A href="https://www.loom.com/">Loom</A>) and Josh Buckley (CEO{' '}
        ...
        OnePager in its current state would work long term.
      </P>
      <P>
        ...
        necessarily metrics of success. We needed to optimize for users,
        revenue, or both and show real growth. The app was in great shape, but
        it didn’t matter. We switched into full business experimentation mode.
        Build, launch, measure, decide next steps. (In hindsight, we may have
      ...
      <P>
        ...
        growth. We left these features in the app as an added bonus to founders.
      </P>
      <P>
        Then we explored OnePager for recruiting after we found user retention
        to be alarmingly low. Users would sign up for OnePager, fundraise, and
        ...
        Fundraise with us, and then with your newly raised capital we can help
        you hire! I built a ton of recruiting features: new data models,
        creation flow, and visualizations. I created an automated newsletter of
        OnePager companies with open roles. I even created a referral bonus
        system baked into recruiting OnePagers. If you reviewed a role that
        seemed relevant to a friend, share it with them. If they get the job,
        you get the referral bonus! This feature set came built with tracking
        and a dashboard for users to review their active referrals.
      </P>
      <P>
        ...
        of OnePager with open arms, creating hundreds of referrals and
        generating thousands of interactions with our job posts. Unfortunately
        though, we found this model extremely difficult to execute. We needed to
        keep three groups of users happy: companies hiring, people referring
        their friends, and job applicants. We also found recruiting to be a
        deeply fragmented and difficult industry to break into. Having only
        committed a few weeks, we decided to move on. We left the recruiting
        features in OnePager, took a positive bump to our user retention, and
        focused our efforts back into the core fundraising OnePager product.
      </P>
      <P>
      ...
      <P>
        ...
        (they get a great tool and exposure) and investor (they get free deal
        flow). The SPVs also add a ton of value for investors: they get access
        to hot deals and a simple way to directly invest. On a more granular
        level, the business model works like this:
      </P>
      ...
      <P>
        ...
        start companies. Helping more founders fundraise does just that, and I’m
