  ...
  return (
    <>
      <P>
        ...
        20-50% of code is generated by copilots today, and in just a few years
        virtually all new software will be created by autonomous agents. So what
        will happen to software engineers in a few years? Is it still worth
        learning how to code?
      </P>
      <P>
        I think we’ll still need software engineers, but they’ll differ from
        today’s engineers and only need two key skills: excellent trade-off
        decision making and great taste.
      </P>
