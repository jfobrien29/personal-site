...
export const EXCERPT =
  'All meaningful code used to be written by humans, but not anymore. What does that mean for software engineers?';

const BlogPost: React.FC<any> = () => {
  return (
    <>
      <P>
        All meaningful code used to be written by humans, but not anymore. Today
        10-30% of code is generated by copilots working with a human programmer,
        and just a few years from now virtually all new software will be created
        by autonomous agents directed by humans. What happens to software
        engineers in a few years? Will we still need them? Is it still worth
