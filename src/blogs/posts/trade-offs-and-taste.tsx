  ...
  return (
    <>
      <P>
        ...
        Today, 20-50% of code is generated by copilots, and in just a few years
        virtually all new software will be created by autonomous agents. What
        will happen to software engineers in a few years? Will we still need
        them? Is it still worth learning how to code?
      </P>
      <P>
