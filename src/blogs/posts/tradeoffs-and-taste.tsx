...
export const TITLE = 'Tradeoffs and Taste';
  ...
  return (
    <>
      <P>
        ...
        About 20-50% of code is generated by copilots today, and in just a few
        years virtually all new software will be created by autonomous agents
        directed by a human. So what will happen to software engineers in a few
        years? Is it still worth learning how to code?
      </P>
      <P>
        I think we’ll still need software engineers, but they’ll differ from
        today’s engineers and only need two key skills: excellent ability to
        decide tradeoffs and great taste.
      </P>
      ...
      <P>
        ...
        dependence, system architecture, database design, and key algorithms all
        with tradeoffs around latency, accuracy, cost, reliability, and ethics.
        Great software engineers know how to evaluate decisions and make the
        best choice, and those choices will still be relevant when agents are
        generating our code.
      </P>
      <P>
        ...
        series of logic gates and tradeoffs expressed through code, you’re
      ...
      <P>
        ...
        to weigh tradeoffs, and learn how to communicate with them to be an
